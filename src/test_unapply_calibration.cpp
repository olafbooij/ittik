...
int main()
{
  ...
  assert((apply_calibration(2.1, 4.3, example_probe_calibration()) - Eigen::Vector3d(-2.71167, 4.50137, -1.0072)).norm() < 1e-4); // fixture
  ...
  assert(fabs(unapply_calibration(apply_calibration(3.15, 19.3, example_probe_calibration()), example_probe_calibration()).first - 3.15 + 2*M_PI) < 1e-5);
