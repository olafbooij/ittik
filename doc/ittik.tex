...
\path{velodynecalib_S2_factory_flatness_intensity.xml}.
The values in this file are used in ITTIK, and for visualization such
as in Figure~\ref{fig:directions}.
